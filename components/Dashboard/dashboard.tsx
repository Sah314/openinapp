...
if(name!="" && email!="" && phone!=""){
  ...
  return (
    <div className="container w-[100vw] h-[100vh]">
      ...
      <div className=" w-full sm:w-80 sm:justify-center bg-gradient-to-b from-blue-500 to-blue-500 rounded-2xl flex sm:flex-col px-2 flex-row justify-between">
  {/* Navbar */}
      ...
      <div className="w-full h-64 bg-white rounded-2xl shadow border border-neutral-200 flex flex-col">
        <div className="JohnDoe text-black text-2xl font-semibold leading-normal m-3 p-3">{userInfo.name}</div>
          <div className=" grid grid-rows-4 sm:grid-cols-2 sm:gap-8 sm:m-2 sm:p-2">
              <div className="h-9 sm:h-12 flex flex-row items-center">
              <div className="Button w-7 h-7 relative bg-emerald-50 rounded-full mx-3">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" className="m-1">
...
<div className="912993881234 text-stone-800 text-sm font-normal underline leading-normal">{userInfo.phone}</div>
              </div>
              <div className="h-9 sm:h-12 flex flex-row items-center">
              <div className="Button w-7 h-7 relative bg-[#FFE9E9] rounded-full mx-3">
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none" className="m-1">
...
<div className="JohnOfficial text-stone-800 text-sm font-normal underline leading-normal">{userInfo.instagram!=""?userInfo.instagram:"No info"}</div>
              </div>
              <div className=" h-9 sm:h-12 flex flex-row items-center">
              <div className="Button w-7 h-7 relative bg-[#EBE6F9] rounded-full mx-3">
...
<div className="JohnXyzCom text-stone-800 text-sm font-normal underline leading-normal">{userInfo.email}</div>
              </div>
              <div className="h-9 sm:h-12 flex flex-row items-center">
              <div className="Button w-7 h-7 relative bg-[#FFE9E9] rounded-full mx-3">
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none" className="m-1">
...
<div className="JohnOfficial text-stone-800 text-sm font-normal underline leading-normal">{userInfo.youtube!=""?userInfo.youtube:"No info"}</div>
              </div>
          </div>
         </div>
    </div>)}
    ...
    {(!infoRetrieved)&&(<div className=" relative flex-1 mt-3 pt-3 sm:ml-3 sm:pl-3" >
      ...
      {isAddNewVisible && (
        <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-slate-100 p-6 rounded-lg shadow-lg">
          <Addnew userInfo={userInfo} setUserInfo={setUserInfo} handleCard2Click={handleCard2Click}/>
        </div>
      )}
    </div>
  );
